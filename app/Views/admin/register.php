...
<head>
    ...
    <link rel="icon" href="<?= base_url() ?>admin/assets/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="<?= base_url() ?>admin/assets/images/favicon.png" type="image/x-icon">
    ...
    <div class="container-fluid p-0">
        <div class="row m-0">
            <div class="col-xl-7 p-0"><img class="bg-img-cover bg-center"
                    src="<?= base_url() ?>assets/images/walpaper.jpg" width="1090" height="930" alt="looginpage">
            </div>
            <div class="col-xl-5 p-0">
                <div class="login-card login-dark">
                    <div>
                        <div><a class="logo text-start" href="index.html"><img class="img-fluid for-light"
                                    src="<?= base_url() ?>assets/images/Logobinjai.png" width="80px"
                                    alt="looginpage"><img class="img-fluid for-dark" width="80px"
                                    src="<?= base_url() ?>assets/images/Logobinjai.png" alt="looginpage"></a>
                        </div>
