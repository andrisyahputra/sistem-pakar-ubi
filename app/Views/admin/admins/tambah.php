        ...
        <div class="job-search">
            <div class="card-body pb-0">
                ...
                <div class="job-description">
                    ...
                    <form class="form theme-form" method="POST" action="<?= url_to('admins.store') ?>">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        id="exampleFormControlInput1" name="nama" placeholder="Enter your full name">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        id="exampleFormControlInput3" name="email" type="email"
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        name="password" id="exampleFormControlpassword" type="password"
                        ...
                        <!-- </form> -->
                        <h4 class="mb-0">Your Education</h4>
                        ...
                        <div class="row select-date">
                            ...
                            <div class="col-xl-6 xl-100">
                                <div class="mb-3">
                                    <div class="col-form-label pt-0">Degree Level:<span class="font-danger">*</span>
                                    </div>
