                ...
                <div class="row mb-5">
                    <div class="col-6 col-md-3 mb-4 mb-md-0">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="<?= base_url() ?>assets/#">Web Design</a></li>
                            <li><a href="<?= base_url() ?>assets/#">Graphic Design</a></li>
                            <li><a href="<?= base_url() ?>assets/#">Web Developers</a></li>
                            <li><a href="<?= base_url() ?>assets/#">Python</a></li>
                            <li><a href="<?= base_url() ?>assets/#">HTML5</a></li>
                            <li><a href="<?= base_url() ?>assets/#">CSS3</a></li>
                        </ul>
                    </div>
                    <div class="col-6 col-md-3 mb-4 mb-md-0">
                        <h3>Company</h3>
                        <ul class="list-unstyled">
                            ...
                            <li><a href="<?= base_url() ?>assets/#">Career</a></li>
                            <li><a href="<?= base_url() ?>assets/#">Blog</a></li>
                            <li><a href="<?= base_url() ?>assets/#">Resources</a></li>
                        </ul>
                    </div>
                    <div class="col-6 col-md-3 mb-4 mb-md-0">
                        <h3>Support</h3>
                        <ul class="list-unstyled">
                            ...
                            <li><a href="<?= base_url() ?>assets/#">Privacy</a></li>
                            <li><a href="<?= base_url() ?>assets/#">Terms of Service</a></li>
                        </ul>
                    </div>
                    <div class="col-6 col-md-3 mb-4 mb-md-0">
                        <h3>Contact Us</h3>
